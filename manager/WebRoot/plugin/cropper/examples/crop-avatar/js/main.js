	...
	if (typeof define === 'function' && define.amd) {
		...
		(function($) {
			...
			function CropAvatar($element) {
				...
				this.$avatarModal = this.$container.find('#avatar-modal');// 模态窗口
			...
			CropAvatar.prototype = {
				...
				addListener : function() {
					...
					this.$avatarSave
							.on('click', $.proxy(this.syncUpload, this));
...
//						$(".avatar-wrapper").empty().html('');
				...
				syncUpload : function() {
					...
					var base64 = this.$img.cropper('getCroppedCanvas')
							.toDataURL('base64', 1);
					uploadPic(base64, url);
				},
